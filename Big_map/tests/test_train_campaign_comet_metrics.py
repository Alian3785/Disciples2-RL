...
def test_campaign_metrics_callback_logs_custom_metrics(monkeypatch):
    ...
    assert payload["campaign/window_enemy_encounters/enemy_31"] == 1.0
    assert payload["campaign/window_enemy_victories/enemy_31"] == 1.0
...
def test_campaign_metrics_callback_flushes_partial_window_on_training_end():
    ...
    assert payload["campaign/window_enemy_encounters/enemy_7"] == 1.0
    assert payload["campaign/window_enemy_defeats/enemy_7"] == 1.0
