"""Continue the frozen PPO experiment; time only the additional transitions."""
import json
import os
...
def main():
    ...
    def learn(self, *args, **kwargs):
        start_steps = int(self.num_timesteps)
        ...
        profile['start_steps'] = start_steps
        profile['additional_steps'] = int(self.num_timesteps) - start_steps
        profile['fps'] = profile['additional_steps'] / profile['learn_seconds']
