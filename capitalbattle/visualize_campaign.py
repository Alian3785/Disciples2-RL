...
Показывает:
1. Карту 10×10 с перемещением агента
...
class CampaignVisualizer:
    ...
    def __init__(self, grid_size: int = 10, cell_size: float = 0.8):
    ...
    def draw_grid(
        ...
        # Castle (heal point) at (1, 1) — highlight in yellow (walk_with_temple only)
